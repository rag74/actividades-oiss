...
import ListadoActividades from "../CorregirListAct/ListadoActividades";
import SkeletonFicha from "../SkeletonFicha/SkeletonFicha";


function ListadoActividadContainer2 ({user,userNIVEL}) {
...
export default ListadoActividadContainer2
