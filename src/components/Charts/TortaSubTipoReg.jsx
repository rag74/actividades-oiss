...
function TortaSubTipoReg({stats, title}) {
    ...
    const colors = ["adb2eb","a5e381","ffe587","c6e3e6","58adb2","7465A2"]
     ...
     const options = {
      ...
      function crearArraysData(objeto) {
        const arrays = [["Subtipo","Cantidad",{type: 'string',label: 'Tooltip Chart',role: 'tooltip','p': {'html': true}}]];
...
export default TortaSubTipoReg

/*
`<div class="toolTipPie"><p>${propiedad}</p><p><strong>${objeto[propiedad]} (${objeto[propiedad]}%)</strong></p></div>`
*/